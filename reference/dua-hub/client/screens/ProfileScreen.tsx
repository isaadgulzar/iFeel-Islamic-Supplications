...
import { View, StyleSheet, Linking, Image, Platform, Pressable } from "react-native";
...
export default function ProfileScreen() {
  ...
  return (
    <MeshGradientBackground variant="default">
      ...
      >
        ...
        <Animated.View entering={FadeInUp.duration(400)} style={styles.logoSection}>
          ...
          <ThemedText style={styles.appName}>Sukoon</ThemedText>
        ...
        <Animated.View entering={FadeInUp.delay(400).duration(400)} style={styles.footer}>
          <ThemedText style={styles.footerText}>Sukoon v1.0.0</ThemedText>
